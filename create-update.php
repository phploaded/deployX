<?php $version='1.241213'; ?><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>deployX update maker v<?php echo $version; ?></title>
<style type="text/css">
body{
margin:0;
padding:0;
...
<body><div class="content"><h1>deployX update maker v<?php echo $version; ?></h1>
